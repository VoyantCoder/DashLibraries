                        ...
                        void Hook1()
                        {
                            try
                            {
                                Sort.Sort(("Close Button"), () =>
                                {
                                    ...
                                    Integrator.Button(Panel1, Button1, ButtonSize,
                                        ButtonLoca, FontPoints, "X", BarBColor, TitleFColor);
                        ...
                        void Hook2()
                        {
                            try
                            {
                                Sort.Sort(("Close & Minimize Buttons"), () =>
                                {
                                    ...
                                    Integrator.Button(Panel1, Button2, ButtonSize,
                                        ButtonLoca, FontPoints, "-", BarBColor, TitleFColor);
