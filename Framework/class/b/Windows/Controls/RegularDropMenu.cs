...
namespace DashFramework
{
	...
	static class RegularDropMenuVisibility
	{
	    public static void RegisterVisibleTrigger(this RegularDropMenu instance, params Control[] Triggers)
	    {
		try
		{
	    ...
	    public static void RegisterInvisibleTrigger(this RegularDropMenu instance, params Control[] Triggers)
	    {
		try
		{
		    void Register(Control Trigger)
